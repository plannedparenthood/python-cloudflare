...
def api_v4(self):
    ...
    setattr(
        zones_custom_certificates, "prioritize",
        self._add_with_auth(self._base, "zones",
    ...
    setattr(
        zones_firewall_waf_packages, "groups",
        self._add_with_auth(self._base, "zones", "firewall/waf/packages",
                                "groups"))
    setattr(
        zones_firewall_waf_packages, "rules",
        self._add_with_auth(self._base, "zones", "firewall/waf/packages",
                            "rules"))

    zones_firewall_access_rules = getattr(zones_firewall, "access_rules")
    setattr(
        zones_firewall_access_rules, "rules",
    ...
    setattr(
        organizations_firewall, "access_rules",
    ...
    organizations_firewall_access_rules = getattr(organizations_firewall,
                                                  "access_rules")
    setattr(
        organizations_firewall_access_rules, "rules",
        self._add_with_auth(self._base, "organizations",
                            "firewall/access_rules/rules"))
    setattr(
        organizations, "virtual_dns",
